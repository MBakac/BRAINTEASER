...
\begin{table*}
	...
	\begin{center}
		\begin{tabular}{lcccccc}
			...
			\midrule
			microsoft/deberta-v3-base & .775              & .775              & .700             & .775                 & .675                                           \\
			FacebookAI/roberta-large  & .850              & .850              & .775             & .850                 & .700                                           \\
			\midrule
			\multicolumn{7}{c}{\textbf{Binary classification problem}}                                                                                                   \\
			microsoft/deberta-v3-base & .650              & .650              & .525             & .625                 & .625                                           \\
			FacebookAI/roberta-large  & .125              & .125              & .125             & .125                 & .125                                           \\
			\midrule
			\multicolumn{7}{c}{\textbf{Pairwise}}                                                                                                                        \\
			\midrule
			microsoft/deberta-v3-base & .650              & .570              & .650             & .650                 & .525                                           \\
			Facebook/roberta-large    & .675              & .700              & .725             & .650                 & .600                                           \\
			\bottomrule
		\end{tabular}
	\end{center}
\end{table*}
...
\begin{table*}
	...
	\begin{center}
		\begin{tabular}{lcccccc}
			...
			\midrule
			deberta-v3-base           & .625              & .688              & .625             & .594                 & .375                                           \\
			FacebookAI/roberta-large  & .312              & .375              & .438             & .250                 & .188                                           \\
			\midrule
			\multicolumn{7}{c}{\textbf{Binary classification problem}}                                                                                                   \\
			\midrule
			...
			\multicolumn{7}{c}{\textbf{Pairwise}}                                                                                                                        \\
			\midrule
			microsoft/deberta-v3-base & .562              & .469              & .500             & .469                 & .250                                           \\
			\bottomrule
		\end{tabular}
	\end{center}
\end{table*}
